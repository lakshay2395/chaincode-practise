...
sudo configtxgen -profile SchoolOneOrgChannel -outputCreateChannelTx ./channel-artifacts/schoolonechannel.tx -channelID schooloneorg
sudo configtxgen -profile SchoolTwoOrgChannel -outputCreateChannelTx ./channel-artifacts/schooltwochannel.tx -channelID schooltwoorg
